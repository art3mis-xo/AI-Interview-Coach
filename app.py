...
with st.sidebar:
    ...
    if st.button("Start Interview", type="primary"):
        st.session_state.coach = InterviewCoach(
            ...
            job_description_path=None if job_desc.strip() else "data/job_descriptions",
        ...
        # Use the exact user-entered position as the interview focus.
        # The Job Description text or saved JD corpus is used as context when available.
        topics = [position]
